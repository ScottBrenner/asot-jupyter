...
nb_path: _notebooks/2020-05-03-track-plays.ipynb
layout: notebook
---
...
#################################################
# file to edit: _notebooks/2020-05-03-track-plays.ipynb
-->
...
<div class="cell border-box-sizing text_cell rendered"><div class="inner_cell">
<div class="text_cell_render border-box-sizing rendered_html">
<p>How many unique artists have been played on A State of Trance over the years? Who's been played the most? How many times has Armin played his own tracks?</p>
...
<p>We can similarly find the number of unique artists featured:</p>
...
<div class="inner_cell">
    <div class="input_area">
<div class=" highlight hl-ipython3"><pre><span></span><span class="nb">print</span><span class="p">(</span><span class="n">top_tracks</span><span class="p">[:</span><span class="mi">10</span><span class="p">])</span>
</pre></div>
...
<div class="output_subarea output_stream output_stdout output_text">
<pre>[(&#39;Rising Star - Clear Blue Moon  - Original Mix&#39;, 10), (&#39;Gareth Emery &amp; STANDERWICK &amp; HALIENE - Saving Light &#39;, 10), (&#39;Solid Globe - North Pole  - Original Mix&#39;, 9), (&#39;Active Sight - The Search For Freedom  - Original Mix&#39;, 9), (&#39;EnMass - CQ  - Original Mix&#39;, 9), (&#39;Jonas Steur - Castamara  - Original Mix&#39;, 9), (&#39;Marco V - Simulated  - Original Mix&#39;, 8), (&#39;Rank 1 - Awakening  - Original Mix&#39;, 8), (&#39;Solarstone &amp; Scott Bond - 3rd Earth  - Original Mix&#39;, 8), (&#39;Pulser - My Religion  - Original Mix&#39;, 8)]
</pre>
</div>
</div>
...
<div class="inner_cell">
    <div class="input_area">
<div class=" highlight hl-ipython3"><pre><span></span><span class="n">source</span> <span class="o">=</span> <span class="n">pd</span><span class="o">.</span><span class="n">DataFrame</span><span class="o">.</span><span class="n">from_dict</span><span class="p">(</span><span class="n">top_tracks</span><span class="p">[:</span><span class="mi">10</span><span class="p">])</span>
<span class="n">alt</span><span class="o">.</span><span class="n">Chart</span><span class="p">(</span><span class="n">source</span><span class="p">)</span><span class="o">.</span><span class="n">mark_bar</span><span class="p">()</span><span class="o">.</span><span class="n">encode</span><span class="p">(</span>
    <span class="n">x</span><span class="o">=</span><span class="n">alt</span><span class="o">.</span><span class="n">X</span><span class="p">(</span><span class="s1">&#39;1:Q&#39;</span><span class="p">),</span>
...
<span class="c1"># (bars + text).properties(height=900)</span>
</pre></div>
...
<div id="altair-viz-a21be7fbc0404173a028bfff300177a6"></div>
<script type="text/javascript">
  (function(spec, embedOpt){
    let outputDiv = document.currentScript.previousElementSibling;
    if (outputDiv.id !== "altair-viz-a21be7fbc0404173a028bfff300177a6") {
      outputDiv = document.getElementById("altair-viz-a21be7fbc0404173a028bfff300177a6");
    }
    const paths = {
  ...
  })({"config": {"view": {"continuousWidth": 400, "continuousHeight": 300}}, "data": {"name": "data-cd3f70afb00bbf39f21706ba1f4247ef"}, "mark": "bar", "encoding": {"x": {"type": "quantitative", "field": "1"}, "y": {"type": "nominal", "field": "0", "sort": "-x"}}, "title": "A State of Trance - Most played tracks", "width": 600, "$schema": "https://vega.github.io/schema/vega-lite/v4.8.1.json", "datasets": {"data-cd3f70afb00bbf39f21706ba1f4247ef": [{"0": "Rising Star - Clear Blue Moon  - Original Mix", "1": 10}, {"0": "Gareth Emery & STANDERWICK & HALIENE - Saving Light ", "1": 10}, {"0": "Solid Globe - North Pole  - Original Mix", "1": 9}, {"0": "Active Sight - The Search For Freedom  - Original Mix", "1": 9}, {"0": "EnMass - CQ  - Original Mix", "1": 9}, {"0": "Jonas Steur - Castamara  - Original Mix", "1": 9}, {"0": "Marco V - Simulated  - Original Mix", "1": 8}, {"0": "Rank 1 - Awakening  - Original Mix", "1": 8}, {"0": "Solarstone & Scott Bond - 3rd Earth  - Original Mix", "1": 8}, {"0": "Pulser - My Religion  - Original Mix", "1": 8}]}}, {"mode": "vega-lite"});
</script>
</div>
